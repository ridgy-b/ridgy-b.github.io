...
L.Control.GeoSearch = L.Control.extend({
    ...
    _config: {
        country: '',
        searchLabel: 'Adress-Suche ...',
        notFoundMessage: 'Die Adresse wurde leider nicht gefunden.',
    ...
    onAdd: function (map) {
        ...
        searchbox.title = 'Suchadresse eingeben; <esc> zum Bereinigen';
    ...
    _selectLocation: function (locations) {
        var elem = this._resultslist;
        for (var i = 0, len = locations.length; i < len; i++) {
             var location = locations[i];
             location.context = this;
             var listelem = document.createElement('li');
             listelem.title = 'lat: ' + location.X + ', lon: ' + location.Y;
             listelem.textContent = location.Label;
             L.DomEvent.addListener(listelem, 'click', this._locSelected, location);
    ...
    _locSelected: function () {
        _this = this.context;
        _this._resultslist.innerHTML = '';
        _this._resultslist.style.display = 'none';
        _this._showLocation(this);
    },
